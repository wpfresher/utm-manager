...
// Remove all the options starting with wpee_.
$delete_all_options = get_option( 'wpee_delete_data' );
if ( empty( $delete_all_options ) ) {
	return;
}
// Delete all the options.
global $wpdb;
$wpdb->query( "DELETE FROM $wpdb->options WHERE option_name LIKE 'wpee_%';" );
