...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/utm-manager` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Navigate to WordPress Admin Dashboard > UTM Manager > Leads & Settings to monitoring the UTM leads.
...
* Compatibility: Compatible with the latest version of WordPress 6.9.
